    ...
    localuserid = 9d3bcaae-c206-4799-aec2-146acfb3b662
    ...
    def CaveDatagameplayitems():
        ...
        for e in data:
            newdata["objects"].append({
                ...
                "key": e["id"],
                "user_id": "9d3bcaae-c206-4799-aec2-146acfb3b662",
                "value": json.dumps(e),
                "version": "5c8518bd84cdb43a4e057cb62ca8d5b1",
                "permission_read": 2,
                "create_time": "2025-05-28T16:03:59Z",
    ...
    @app.route('/nakamacloud.c/v2/rpc/clientBootstrap', methods=['GET', 'POST'])
    def CaveDatabootstrap():
        payload = {
            "updateType": "None",
            "attestResult": "Valid",
            "attestTokenExpiresAt": 1754647002,
            "photonAppID": PhotonAppId5,
            "photonVoiceAppID": PhotonVoiceAppId5,
            "metadataHash": "b43edb717cc4045cfdd0f7f0f5df6133d3f73ea5144f83a30f952ce00fb9c81a",
            "termsAcceptanceNeeded": [],
            "dailyMissionDateKey": "",
            "dailyMissions": None,
            "dailyMissionResetTime": 0,
            "serverTimeUnix": 1754603899,
                ...
                'purchases': [
                    {
                        ...
                        'metadata': '{}',
                        'id': '9d3bcaae-c206-4799-aec2-146acfb3b6626',
                        'purchase_id': 'p12345',
